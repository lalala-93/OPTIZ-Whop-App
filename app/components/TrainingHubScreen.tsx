  ...
  return (
    <div className="pb-8">
      ...
      <div className="relative rounded-2xl overflow-hidden mb-4 aspect-[2/1]">
        <Image src={program.image} alt={program.title} fill className={`object-cover ${program.id === "optiz-start" ? "object-top" : "object-[center_70%]"}`} sizes="(max-width: 768px) 100vw, 600px" />
          ...
          return (
            ...
            >
              ...
              <div className="relative h-36">
                <Image src={prog.image} alt={prog.title} fill className={`object-cover ${prog.id === "optiz-start" ? "object-top" : "object-[center_70%]"}`} sizes="(max-width: 768px) 100vw, 600px" />
