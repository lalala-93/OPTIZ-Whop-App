                    ...
                    >
                        ...
                        <div className="p-6 pt-8">
                            <div className="flex flex-col items-center mb-6">
                                ...
                                <h2 className="text-xl font-black text-gray-12 mt-4 tracking-tight">{t("whatIsOptiz")}</h2>
                            </div>
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="grid grid-cols-2 gap-2.5">
                                    {[
                                        { emoji: "⚡", title: t("earnXp"), desc: t("earnXpDesc") },
                                        { emoji: "🏆", title: t("rankUp"), desc: t("rankUpDesc") },
                                        { emoji: "🔥", title: t("buildStreaks"), desc: t("buildStreaksDesc") },
                                        { emoji: "📊", title: t("compete"), desc: t("competeDesc") },
                                    ].map((item) => (
